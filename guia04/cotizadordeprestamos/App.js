...
//Importar formato de colores desde archivo creado en colors
...
export default function App(){
  ...
  return(
    ...
    <Result capital={capital} interest={interest} months={months} total={total} errorMessage={errorMessage}/>
